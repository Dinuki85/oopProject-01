abstract class LibraryItem {
    ...
    public void checkOut() {
        if (!checkedOut) {
            checkedOut = true;
            System.out.println(title + " (" + itemID + ") has been checked out.");
        } else {
            System.out.println(title + " (" + itemID + ") is already checked out.");
        }
    }
    ...
    public void checkIn() {
        if (checkedOut) {
            checkedOut = false;
            System.out.println(title + " (" + itemID + ") has been checked in.");
        } else {
            System.out.println(title + " (" + itemID + ") is already checked in.");
        }
    }
...
public class LibraryManagementSystem {
    public static void main(String[] args) {
        ...
        LibraryMember member5 = new LibraryMember("L005", "Michael Brow");
